...
def task_generate_meta_schemas():
  ...
  return {
    'file_dep': [schema_info.schema.file_path for schema_info in data_model_205.schema_info],
    'targets': [schema_info.meta_schema_path for schema_info in data_model_205.schema_info],
    'actions': [
...
def task_generate_json_schemas():
    ...
    return {
        ...
        'file_dep': [schema_info.schema.file_path for schema_info in data_model_205.schema_info]
        + [schema_info.meta_schema_path for schema_info in data_model_205.schema_info],
        "targets": [schema.json_schema_path for schema in data_model_205.schema_info],
...
def task_generate_web_docs():
    ...
    return {
        "task_dep": ["validate_schemas", "generate_json_schemas", "validate_example_files"],
        "file_dep": [schema_info.schema.file_path for schema_info in data_model_205.schema_info]
        + [template.path for template in data_model_205.doc_templates],
...
def task_generate_cpp_project():
  ...
  return {
    'file_dep': [schema_info.schema.file_path for schema_info in data_model_205.schema_info],
    'targets': [schema_info.cpp_header_file_path for schema_info in data_model_205.schema_info]
                + [schema_info.cpp_source_file_path for schema_info in data_model_205.schema_info]
