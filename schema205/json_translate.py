        ...
        try:
            ...
            if m:
                ...
                if len(m) > 1:
                    ...
                    target_property_entry['minItems'] = 1
                # 3. 'items' entry
                ...
                if 'Range' in parent_dict:
                    self._get_simple_minmax(parent_dict['Range'], target_property_entry['items'])
            else:
                ...
                if m and selector:
                    ...
                    self._get_simple_minmax(parent_dict['Range'], target_property_entry)
